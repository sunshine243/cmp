                                ...
                                <div class="card border-right border-primary rounded-0">
                                    <div class="card-body">
                                        <div class="col-12 text-truncate">
                                            ...
                                            <?php if ($name == 'admin'): ?>
                                                <a href="../../manage_post.php?school_name=<?php echo urlencode($school_name); ?>&post=<?php echo urlencode($display_name); ?>.html" class="btn btn-sm rounded-0" style="background-color: #f0ad4e; color: #000; border: none; font-size: 20px; padding: 10px 20px; border-radius: 12px;">Edit</a>
                                                <a href="../../delete_post.php?school_name=<?php echo urlencode($school_name); ?>&post=<?php echo urlencode($display_name); ?>.html" class="btn btn-sm rounded-0" style="background-color: #d9534f; color: #fff; border: none; font-size: 20px; padding: 10px 20px; border-radius: 12px;">Delete</a>
                                            <?php endif; ?>
                                        </div>
