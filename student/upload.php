...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $userId = $_SESSION['id'];
        $query = "SELECT profile_image FROM student WHERE id='$userId'";
        ...
        $updateQuery = "UPDATE student SET profile_image='$filePath' WHERE id='$userId'";
        if (mysqli_query($con, $updateQuery)) {
            echo "Profile image updated successfully.";
            echo "<br><a href='student_index.php'>Go back to Home</a>";
        } else {
