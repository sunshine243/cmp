...
$role =$_REQUEST['role'];
$update = "UPDATE teacher SET full_name='" . $full_name . "', username='" . $username . "', email='" . $email . "', gender='" . $gender . "', password='" . md5($password) . "', role='" . $role . "' WHERE id='" . $id . "'";
...
<p><input type="text" name="role" placeholder="Update Role"
