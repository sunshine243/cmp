...
if(isset($_POST['new']) && $_POST['new'] == 1){
    ...
    $ins_query="INSERT into student (`full_name`,`email`,`gender`,`profile_desc`,`profile_image`,`password`)values
    ...
    if($result){
        $status = "New Student Inserted Successfully. </br></br><a href='ViewTeacherList.php'>View Teacher List</a>";
    } else {
            ...
            <div class="main_container">
                <div class="navbar">
                    ...
                    <div class="logo">
                        ...
                        <a href="ViewSchoolList.php">View Student List</a>
                    </div>
                </div>
