...
| <a href="AddStudent.php">Add New Student</a></p>
...
$role = "student";
$update = "UPDATE student SET full_name='" . $full_name . "', username='" . $username . "', email='" . $email . "', gender='" . $gender . "', password='" . md5($password) . "', role='" . $role . "' WHERE id='" . $id . "'";
mysqli_query($con, $update) or die(mysqli_error($con));
$status = "Student List Updated Successfully. </br></br>
<a href='ViewStudentList.php'>View Updated Record</a>";
