                ...
                <div class="sidebar_inner">
                    ...
                    <ul class="siderbar_menu">
                        ...
                        <li>
                            ...
                            <ul class="accordion">
                                <li><a href="teacher_list.php" class="active"><i class="fas fa-user-plus pr-1"></i>Teacher List</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="accordion">
                                <li><a href="student_list.php" class="active"><i class="fas fa-users pr-1"></i>Student List</a></li>
                            </ul>
