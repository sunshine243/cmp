...
<body>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="./save_page.php" id="content-form" method="POST">
                            ...
                            <?php echo isset($_SESSION['POST']['content']) ? $_SESSION['POST']['content'] : (isset($_GET['page']) ?
                                file_get_contents("./pages/{$_GET['page']}") : '')  ?></textarea>
                            </div>
                        </form>
                    </div>
    ...
    <style>
        .btn-custom {
            ...
            color: white; /* 字体颜色 */
            border-radius: 20px; /* 角的圆度 */
            padding: 10px 20px; /* 按钮的内边距，调整大小 */
            font-size: 16px; /* 字体大小 */
            border: none; /* 去掉边框 */
    ...
    <button class="btn btn-custom" type="submit" form="content-form">Save</button>
    <button class="btn btn-custom" type="button" onclick="redirectToIndex()">Cancel</button>
    ...
    <script>
        function redirectToIndex() {
            ...
            if ($name == "admin") {
                ...
                echo "window.location.href='./teacher/teacher_index.php';";
            }
            ?>
        }
    </script>
